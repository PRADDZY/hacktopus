  ...
  return (
    <>
      <div className="space-y-6">
        <div>
          <p className="section-kicker">Live Portfolio</p>
          <h1 className="section-title">Risk Management Dashboard</h1>
          <p className="text-sm text-muted mt-2">Monitor and manage EMI requests in real-time.</p>
        </div>
